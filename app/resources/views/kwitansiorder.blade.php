           ...
           <div class="card">
               <div class="card-body p-0">
                   ...
                   <div class="row pb-5 p-5">
                       <div class="col-md-6">
                           <p class="font-weight-bold mb-4"><b>Informasi Pemesan</b></p>
                           <p class="mb-1"> Nama: {{$namapeserta}} </p>
                           <p> Institusi/Alamat: {{$institusi}}</p>
                  ...
                  <hr>
                   Cetak versi PDF => <a target="_blank" href="{{url('/seminar/invoice/'.$unik)}}">   {{url('/seminar/inv/'.$unik)}}</a> 
                   <br>               
