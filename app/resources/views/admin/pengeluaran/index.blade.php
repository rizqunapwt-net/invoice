                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                      <select required  name="katpengeluaran_id" class="form-control select2 custom-select"  style="width: 100%;">
                          ...
                          @foreach ($katpengeluaran as $item)
                          ...
                          @csrf
                            <div class="input-group">
                                <input type="text" class="form-control" name="q"
                                    placeholder="Search pengeluaran"> <span class="input-group-btn">
...
<div class="modal fade" id="edit{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="edit{{$data->id}}Label" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="edit{{$data->id}}Label">Edit pengeluaran</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<input type="hidden" name="id" value="{{$data->id}}">
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                      <input type="text" name="keterangan" required class="form-control" value="{{$data->keterangan}}">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('detailuser',$data->id)}}">{{$data->keterangan}}</a></td>
                                    ...
                                    <td>
                                      ...
                                      <i class="far fa-edit"></i></button>
                                        <form action="{{route('pengeluaran.hapus',$data->id)}}" method="POST">
                                            @csrf
                                            @method('delete')
