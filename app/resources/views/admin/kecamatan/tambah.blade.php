        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal" method="post" action="{{route('kecamatan.simpan')}}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="kecamatan" class="form-control" id="fname" placeholder="nama kecamatan">
                                </div>
                            </div>
