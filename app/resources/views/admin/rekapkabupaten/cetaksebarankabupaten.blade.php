...
<body>
 ...
 <table class="kop">
<tr>
    <td><h3>SEBARAN NILAI USBN PAI TAHUN <br>{{$tahunajaran->namatahunajaran}}</h3></td>
</tr>
 </table>
 <br>
 ...
 <table class="judul">
   ...
   <tr><td>2. Nilai Tertinggi Tingkat Kabupaten</td><td>: {{$max->n_teori}}</td></tr>
   <tr><td>3. Nilai Terendah Tingkat Kabupaten</td><td>: {{$min->n_teori}}</td></tr>
   <tr><td>4. Nilai Rata-rata Sekolah Tertinggi</td><td>: {{ number_format($max_avg->ratarata,2)}}</td></tr>
   <tr><td>5. Nilai Rata-rata Sekolah Terendah</td><td>: {{ number_format($min_avg->ratarata,2)}}</td></tr>
<tr><td>6. Nilai Rata-rata Siswa tingkat Kabupten</td><td>: {{ number_format($rata,2) }} </td></tr>

<tr><td>7. Rentang Nilai tingkat Kabupten</td><td>:  </td></tr>
</table>
...
<div style="margin-left:50px">
                    ...
                    <table class="judul">
                        <tr>
                           <td>8. Peringkat 10 Besar Tingkat Kabupaten</td><td>:</td>
                    ...
                    <table class="daftarhadir"  >
                        ...
                        <tbody>
                            ...
                            <tr><td>{{$loop->iteration}}</td>
                                <td>{{ucwords($rank->nama)}}</td>
                                
                                <td>
                                   {{$rank->sekolah->namasekolah}}
                                    
                                </td>
                                <td>{{$rank->sekolah->status}}</td>
                                <td>
                                   {{$rank->kecamatan->kecamatan}}
                                     
                                    </td>
                                <td align="center">{{$rank->n_teori}}</td>
                                <td align="center">{{$loop->iteration}}</td></tr>
