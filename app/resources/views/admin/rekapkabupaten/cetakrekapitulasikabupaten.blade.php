...
<body>
 ...
 <table class="kop">
<tr>
    <td><h3>REKAPITULASI NILAI USBN PAI TINGKAT {{$jenjang->jenjang}} KABUPATEN/KOTA <br> TAHUN {{$tahunajaran->namatahunajaran}}</h3></td>
</tr>
 </table>
 <br>
                        ...
                        <table class="daftarhadir"  >
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%">Nilai Tertinggi</th>
                                    <th width="10%">Nilai Terendah</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($sk->id == $data->sekolah_id)
                                    {{$sk->namasekolah}}
                                    @php 
                                    $kecamatan_id=$sk->kecamatan_id;
                                    @endphp
                                    @endif
                                    @endforeach
                                ...
                                <td>{{$data->terendah}}</td>
                                <td>{{number_format($data->ratarata,2)}}</td>
                                <td>{{$loop->iteration}}</td>
