...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">REKAP NILAI per sekolah</h4>
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Rekap nilai per sekolah</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal" method="post" action="{{route('datarekapsekolah')}}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Pilih Jenjang</label>
                                <div class="col-sm-9">
                                    <select name="jenjang_id" class="form-control select2" required>
                                        <option value="">pilih</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="sekolah_id" class="select2 form-control custom-select" required style="width: 100%; height:36px;"> 
                                        <option value="">pilih</option>
