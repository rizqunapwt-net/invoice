            ...
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Rekap Nilai  Kec. {{$kecamatan->kecamatan}}</li>
                    </ol>
                </nav>
        </div>
        </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <a target="_blank" href="{{route('cetakrekapkecamatan',[$tahunajaran->id,$kecamatan->id,$jenjang->id])}}" class="btn btn-success"><i class="mdi mdi-printer"></i>laporan</a>
            {{-- <a target="_blank" href="{{route('cetakrekapitulasi.kecamatan',[$tahunajaran->id,$kecamatan->id,$jenjang->id])}}" class="btn btn-info"><i class="mdi mdi-printer"></i>rekap</a>
            <a target="_blank" href="{{route('cetakrekapsikap.kecamatan',[$tahunajaran->id,$kecamatan->id,$jenjang->id])}}" class="btn btn-warning"><i class="mdi mdi-printer"></i>n_sikap&n_praktek</a> --}}
            <div class="card">
                <div class="card-body">
