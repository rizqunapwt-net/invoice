...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">REKAP NILAI per Kecamatan</h4>
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Rekap nilai per kecamatan</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal" method="post" action="{{route('datarekapkecamatan')}}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="kecamatan_id" class="select2 form-control custom-select" required style="width: 100%; height:36px;">
                                        <option value="">pilih</option>
