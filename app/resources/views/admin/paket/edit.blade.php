                    ...
                    <form class="form-horizontal" method="post" action="{{route('paket.update',$paket->id)}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="namapaket" class="form-control" id="fname" value="{{$paket->namapaket}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="status" class="form-control" id="fname"  >
                                        <option value="{{$paket->status}}">{{$paket->status}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="harga" class="form-control" id="fname" value="{{$paket->harga}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Diskon</label>
                                <div class="col-sm-9">
                                    <input type="number" name="diskon" class="form-control" id="fname" value="{{$paket->diskon}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="col-sm-12">
                                        <textarea  name="deskripsi" class="form-control ckeditor">{{$paket->deskripsi}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="recommended" class="form-control" id="fname"  >
                                        <option value="{{$paket->recommended}}">{{$paket->recommended}}</option>
