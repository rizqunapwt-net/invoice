    ...
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Data Peserta Seminar {{$seminar->namaseminar}}<br>
                ...
                <a href="{{route('cetakpresensi',$seminar->id)}}" class="btn btn-success btn-xs" target="_blank"><i class="fas fa-print"></i>Presensi</a>
            ...
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{route('adminseminar.detail',$seminar_id)}}">Seminar detail</a></li>
                    </ol>
                </nav>
            </div>
        </div>
