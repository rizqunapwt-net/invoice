                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('tambahorder') }}">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-12">
                               <input type="text" name="satuan" value="eks" class="form-control">
...
<div class="modal fade" id="konfirmasi{{$dt->id}}" tabindex="-1" role="dialog" aria-labelledby="uploadLabel" aria-hidden="true">
                  ...
                  <div class="modal-body">
                      <form method="POST" action="{{ route('tambahorder') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                   <input type="text" name="satuan" class="form-control" required value="eks">
                                @error('satuan')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                  ...
                  <div class="modal-body">
                      <form method="POST" action="{{ route('editorder') }}">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-12">
                              <input type="text" name="satuan" value="{{ $dt->satuan }}" class="form-control">
  ...
  @endphp 
                                <tr>
                                 <td> {{ $loop->iteration+$skipped-$data->perPage()}}</td>
