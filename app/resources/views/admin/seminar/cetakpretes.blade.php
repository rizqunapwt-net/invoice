...
<div class="container">
    <center>
<h5>SOAL PRE-TEST <br>{{$seminar->namaseminar}}</h5>
    </center>
                    <div class="table-responsive"><div style="margin-left:550px;position:absolute">
                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')
                            ->size(100)->errorCorrection('H')
                            ->generate('http://mesem.rizquna.id/validasipretes/semid/'.$seminar->id.'/pre/u/'.$duser['id'])) !!} ">
                        </div>
                        <table class="table ">
                            <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <?php
                                    ...
                                    ->first(); ?>
                       <i>jawaban: {{ $jwb['pilihanpretes_id'] }}</i>
                                    <?php }  
