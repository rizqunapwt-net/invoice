                ...
                @endif
                    ...
                    @endphp
                            ...
                            <td>{{$data->pemilik_rekening}}
                                    ...
                                    <td>
                                        <?php
                                        $pemesanan= \App\Pemesanan::where('kodeinvoice',$data->kodeinvoice)->first();
                                        
                                          
                                  ?>
                                        @if($pemesanan->statusbayar == 'lunas')
                                        OK
                                        @else
                                        <form action="{{route('lunas')}}" method="POST">
                                            ...
                                            <input type="hidden" name="kodeinvoice" value="{{$data->kodeinvoice}}">
                                             
                                            
                                        <button  data-toggle="tooltip" data-placement="top" title="Lunas"   type="submit"   class="btn btn-icon btn-sm  btn-success"><i class="fas fa-user"></i>terima pembayaran</button>
