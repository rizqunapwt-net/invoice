                ...
                @endif
                    <div class="table-responsive">
                        <table class="table ">
                            ...
                            <tbody>
                                <form method="post" action="{{route('simpanjawabanpostes')}}">
                                    @csrf
                                <?php $i=0;?>
                                @foreach ($postes as $data)
                                      ...
                                      <input type="hidden" name="postes_id{{$i}}" value="{{$data->id}}">
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        ...
                                        <ol type="A">
                                            ...
                                            if ($cekpilihan==0){
                                                $cekjwb=\App\Jawabanpostes::where('postes_id',$data->id)
                                            ...
                                            ->first();  
                                            ?> <input   type='text' class="form-control" name="pilihan{{$i}}" 
                                        required value="{{ $jwb->pilihanpostes_id }}" > 
                                         <?php   
                                                 }
                                             }
