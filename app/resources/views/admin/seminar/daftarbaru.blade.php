                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('seminar.simpandaftarbaru')}}" method="POST">
                                            ...
                                            <input type="hidden" name="berbayar" value="{{$data->berbayar}}">

                                            <button type="submit" data-toggle="tooltip" data-placement="top" title="daftar sekarang?" class="btn btn-icon btn-xs btn-warning"><i class="far fa-edit"></i>daftar sekarang?</button>
