            ...
            <div class="card">
                ...
                @endif
                    <div class="table-responsive">
                      <a href="{{route('cetakpretes',$seminar->id)}}" target="_blank" class="btn btn-success btn-xs">cetak</a>
                      <a href="{{route('belumpretes',$seminar->id)}}" target="_blank" class="btn btn-danger btn-xs">yang belum pretes</a>
                                ...
                                <tr>
                                 ...
                                 <?php
                                    ...
                                    foreach ($pilihan as $pil) {
                                        $jum=\App\Jawabanpretes::where('pilihanpretes_id',$pil->id)->count();
                                        if($total>0)
                                        {
