        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal" method="post" action="{{route('sekolah.simpan')}}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="npsn" class="form-control" id="fname" placeholder="NPSN">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama sekolah</label>
                                <div class="col-sm-9">
                                    <input type="text" name="namasekolah" class="form-control" id="fname" placeholder="nama sekolah">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-3 text-right control-label col-form-label">Alamat</label>
                                <div class="col-sm-9">
                                    <input type="text" name="alamat" class="form-control" id="fname" placeholder="alamat sekolah">
                                </div>
                            </div>
                            <div class="form-group row">
