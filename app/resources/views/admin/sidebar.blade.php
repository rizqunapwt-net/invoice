<aside class="left-sidebar" data-sidebarbg="skin5" style="background:#1A5276">
    ...
    <div class="scroll-sidebar" style="background:#1A5276;">
        ...
        <nav class="sidebar-nav" style="background:#1A5276;">
            ...
            <li class="sidebar-item" style="background:#1A5276;"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('dataorder')}}" aria-expanded="false"><i class="fas fa-sticky-note"></i><span class="hide-menu">Data Order</span></a></li>
