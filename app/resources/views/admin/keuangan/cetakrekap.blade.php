 ...
 <div style="margin-left:20px">
                        ...
                        <table class="daftarhadir"  >
                            ...
                            <tbody>
                                ...
                                @endforeach
                                <tr><td colspan="4"><h4>Total Pemasukan</h4></td><td align="right"><b>{{number_format($totalpemasukan)}}</b></td><td></td></tr>
                                ...
                                @endforeach
                                <tr><td colspan="5"><h4>Total Pegeluaran</h4></td><td align="right"><b>{{number_format($totalpengeluaran)}}</b></td></tr>
                                <tr><td colspan="2"><h4>GRAND TOTAL<b> </td><td colspan="4" align="center"><h4> {{number_format($totalpemasukan-$totalpengeluaran)}}</b></h4></td></tr>
                            </tbody>
